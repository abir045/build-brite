...
// const FeaturedProjects: React.FC = () => {
//   const swiperRef = useRef<SwiperType | null>(null);
//   const [expandedIndex, setExpandedIndex] = useState<number>(0); // Always a number, default first card
//   const [isMobile, setIsMobile] = useState(false);
...
//     }
//     // Immediately expand the hovered card
//     setExpandedIndex(index);
//   };

//   const handleCardLeave = () => {
//     // Add small delay to prevent flicker when moving between cards
//     if (hoverTimeoutRef.current) {
//       clearTimeout(hoverTimeoutRef.current);
//     }
//     hoverTimeoutRef.current = setTimeout(() => {
//       setExpandedIndex(0); // Reset to first card
//     }, 100);
//   };
...
//           >
//             {projectsData.map((project, index) => {
//               // Only the expandedIndex card is expanded
//               const isExpanded = expandedIndex === index;

//               // const isExpanded = isMobile ? false : expandedIndex === index;
...
//                 // if (isMobile) {
//                 //   return "280px"; // Fixed width on mobile
//                 // }
//                 // if (isExpanded) {
//                 //   return "896px"; // expanded on desktop
//                 // }
//                 // return "224px"; // collapsed on desktop
//               };
...
//   // Expanded card (responsive) - Fixed height to prevent vertical expansion
//   return (
//     <div className="flex relative flex-col md:flex-row w-full h-auto md:h-[450px] bg-[#0E141B] text-white overflow-hidden">
//       {/* Image Section */}
...
const FeaturedProjects: React.FC = () => {
  ...
  // GSAP animation for width changes
  useEffect(() => {

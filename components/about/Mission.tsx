...
const missionData = {
  ...
  description:
    "To deliver world-class construction and management services that exceed client expectations, while fostering a culture of safety, integrity, and continuous improvement. We partner with our clients to transform their vision into reality, creating lasting value for communities worldwide.",
...
export default function Mission() {
  return (
    <section
      className="relative h-[500px] md:h-[750px] w-full"
      data-theme="dark"
    >
      <Image
      ...
      {/* <div className="container-custom">
        <div className={`absolute bottom-[100px] left-10 right-10 `}>
          <div className="flex flex-col gap-4 items-center  md:flex-row md:items-end md:gap-[140px] ">
